...
var git = module.exports = {
	...
	//runner: 'NODE_ENV=ci ./node_modules/.bin/mocha --ui bdd --timeout 5s --reporter json test/specs',
	coverage: 'make test-cov-ciruela',
	//coverage: 'NODE_ENV=ci HTMLCOV=1 ./node_modules/.bin/mocha test/specs --reporter html-cov > test/reports/coverage.html',
	branch: '',
	user: '',
	repoName: '',
