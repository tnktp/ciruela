    ...
    sendBuildResult: function (buildResult) {
        ...
        emailTemplates(templatesDir, function(err, template) {
            ...
            template(config.emailTemplateDir, locals, function(err, html, text) {
                ...
                var subject = 'Success: org/' + buildResult.repoName + ' [' + buildResult.branch + '] by ' + buildResult.commit.author.username + ': ' + buildResult.commit.message
                transport.sendMail({
                    ...
                    if (responseStatus) {
                        console.log((responseStatus.message).grey);
                        return;
                    }
                });
            });
